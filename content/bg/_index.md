...
features:
  - title: "Евангелска Съборна Църква"
    ...
    content: 'Място, където **всеки е добре дошъл**. Срещаме се на [ул."Добруджа" 47, гр. Хасково](https://maps.app.goo.gl/pHphApJnuSjVdv3p8)'
  ...
  - title: "Ще се радваме да се запознаем с теб!"
    ...
    content: "Църквата е отворена **ежедневно** за молитва, съвет или подкрепа. Също така организираме **седмични** молитвени събрания и богослужения. Нашите събирания са чудесно място за изследване на християнската вяра и среща с други вярващи."
    button:
      enable: false
